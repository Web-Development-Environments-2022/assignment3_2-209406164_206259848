...
//remote:
app.use(express.static(path.join(__dirname, '../assignment3-3-209406164_206259848/dist')));
app.get("/",function(req,res)
{ 
  //remote: 
  res.sendFile(path.join(__dirname, '../assignment3-3-209406164_206259848/dist/index.html'));
  //local:
